...
def nationality_search(countries, cur, conn):
    ...
    for country in countries:
        table = cur.execute('SELECT name, position_id, nationality FROM Players WHERE country = nationality')
...
def position_birth_search(position, age, cur, conn):
       ...
       cur.execute('SELECT Players.name, Positions.position, Players.birthyear FROM Players JOIN Positions ON birthyear WHERE birthyear > (age)')
       for player in cur:
           lst.append(player)
